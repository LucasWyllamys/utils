...
Sub inicioLog(caminhoLog As String, log As clsLogger, qtdItens As Long, ti As Date, sistema As String)
    Dim psPID As Long
...
Sub linhaLog(log As clsLogger, linha As Long, qtdItens As Long, status As String, template As String)
    With log
        .UnformattedMessage ""
...
Sub fimLog(log As clsLogger, qtdItens As Long, ti As Date, num_executados As Long, num_naoExecutados As Long, num_falhas As Long)
    With log
        .UnformattedMessage ""
        .UnformattedMessage "------------------------------------------------------------------------"
